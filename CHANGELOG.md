...
### Documentation
- **Discord bot output architecture documented** — 12-fix output polish pass
  completed, unified pipeline architecture described in `docs/bot/output-architecture.md`.
