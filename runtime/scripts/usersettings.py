...
FIELD_DESCRIPTIONS = {
    ...
    "spice_spawning_active": "Intended as a master on/off for the spice spawning system, but observed live on a real server (2026-09-21) to NOT fully stop new spice fields from spawning when set to False -- new fields still appeared during two separate test windows. Treat this field as unreliable until that's understood; do not rely on it to fully halt spawning. See issue #998 for the evidence and follow-up.",
