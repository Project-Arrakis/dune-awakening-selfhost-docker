...
This console's own separate OAuth login (#4) works the same way — its own
configuration, checked independently, defaulting to owner-only until you
configure it — regardless of whether a bot is installed at all.
