...
> file a documentation issue against
> [`yacketrj/dune-awakening-selfhost-docker`](https://github.com/yacketrj/dune-awakening-selfhost-docker).
...
- [GitHub Issues](https://github.com/yacketrj/dune-awakening-selfhost-docker/issues) — bug reports and documentation gaps (including the addon-UI gap noted in §6).
