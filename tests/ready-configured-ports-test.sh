...
# runtime-env.sh now sources lib/secrets.sh (age-based secrets manager) --
# this disposable test tree must carry that dependency too, or sourcing
# runtime-env.sh fails with "No such file or directory" in this isolated
# copy, even though the real repo has it.
