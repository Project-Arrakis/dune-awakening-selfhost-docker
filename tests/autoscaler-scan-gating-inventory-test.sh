...
# 5s) rather than sharing NAMED_DESTINATION_SCAN_SECONDS -- see the commit
# that added this interval for why a shared 60s interval was too slow for a
# player waiting on a stuck story return, and why a short dedicated interval
# is the fix rather than leaving this scan ungated altogether.
