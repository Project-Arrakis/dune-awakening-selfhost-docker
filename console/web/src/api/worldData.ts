...
export const worldDataApi = {
  ...
  storageFillItem: (id: string, body: { itemName: string; quantity: number; confirmation: string }) => post<{ supported: boolean; result?: Record<string, unknown>; reason?: string }>(`/api/storage/${encodeURIComponent(id)}/fill-item`, body),
