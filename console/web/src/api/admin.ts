...
export const adminApi = {
  ...
  saveLandsraadVendorOverride: (body: { enabled: boolean; mode: "fixed" | "rotate"; vendorKeys: LandsraadVendorKey[]; overrideResolvedTerm?: boolean }) => post<{ preset: LandsraadVendorOverridePreset; result: LandsraadVendorOverrideResult }>("/api/admin/landsraad/vendor-override", body),
